  ...
  return (
    <>
      ...
      <div className='flex h-screen'>
        <div className='flex flex-col w-full pl-0 mb-4 bg-black border-t border-b border-r border-black border-3'>
          ...
          <div className='px-5 mt-5'>
            ...
            <div className='flex justify-between pt-5 mt-5 border-t border-gray-500'>
